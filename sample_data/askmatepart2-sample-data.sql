...
ALTER TABLE IF EXISTS ONLY public.sessions DROP CONSTRAINT IF EXISTS pk_user_session_id CASCADE;
ALTER TABLE IF EXISTS ONLY public.sessions DROP CONSTRAINT IF EXISTS fk_user_id CASCADE;
